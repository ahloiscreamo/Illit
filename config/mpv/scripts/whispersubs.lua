...
local WHISPER_CMD = "/home/ahloi/Scripts/whisper.cpp/build/bin/whisper-cli -m /home/ahloi/Scripts/whisper.cpp/models/ggml-base.bin -l zh --translate --threads 3 --no-prints"
